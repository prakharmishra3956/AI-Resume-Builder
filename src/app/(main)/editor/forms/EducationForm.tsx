...
import { educatiionSchema, EducationValues } from "@/lib/validation"; // ✅ fixed typo: educatiionSchema -> educationSchema
...
export default function EducationForm({
  ...
  const form = useForm<EducationValues>({
    resolver: zodResolver(educatiionSchema),
    defaultValues: {
    ...
    <div className="mx-auto max-w-xl space-y-6">
      <div className="space-y-1.5 text-center">
        ...
        <p className="text-muted-foreground text-sm">
          Add as many educational qualifications as you like.
        </p>
      </div>
      <Form {...form}>
